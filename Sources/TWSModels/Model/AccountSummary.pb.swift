...
public nonisolated struct IBPBAccountSummary: Sendable {
...
nonisolated extension IBPBAccountSummary: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AccountSummary"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}reqId\0\u{1}account\0\u{1}tag\0\u{1}value\0\u{1}currency\0")
  ...
  public static func ==(lhs: IBPBAccountSummary, rhs: IBPBAccountSummary) -> Bool {
