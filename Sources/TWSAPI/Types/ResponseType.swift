...
public enum ResponseType: Int32, Sendable{
	case TICK_PRICE = 1
	case TICK_SIZE = 2
	case ORDER_STATUS = 3
	case ERR_MSG = 4
	...
	case COMMISSION_AND_FEES_REPORT = 59
	...
	case USER_INFO = 107
	case HISTORICAL_DATA_END = 108
	case CURRENT_TIME_IN_MILLIS = 109
	case CONFIG_RESPONSE = 110
	case UPDATE_CONFIG_RESPONSE = 111
}
